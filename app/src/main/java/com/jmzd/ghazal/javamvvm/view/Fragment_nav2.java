...
TextView bundleTv ;
     ...
     * @return A new instance of fragment Fragment_nav2.
     */
    // TODO: Rename and change types and number of parameters
    public static Fragment_nav2 newInstance(String param1, String param2) {
        Fragment_nav2 fragment = new Fragment_nav2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_nav2, container, false);
         bundleTv = view.findViewById(R.id.bundleTv);
        bundleTv.setText(getArguments().getString("name"));
        return view ;
    }
}